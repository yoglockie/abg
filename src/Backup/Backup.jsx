        ...
        reader.onload = (event) => {
         ...
         // Send the base64String to the server
          fetch('https://mandelbulbtech.in/upload', {
            ...
            body: JSON.stringify({user:user, userid:userid, image: base64Content, filename:fileName, from:from, to:to, mmm:labResult }),
          })
            .then(response => {
              if (!response.ok) {
